    ...
    <Box className='bg-tertiary' sx={{ width: '100%', border: '1px solid black', borderRadius: '4px', overflow: 'hidden', p: 2 }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Box sx={{ p: 2, backgroundColor: '#FF5733', borderRadius: '4px 4px 0 0' }}>
          ...
          <Box key={`section1`} sx={{ p: 2, borderBottom: '1px solid black' }}>
            <Typography>{local.strings.apprentissagecritique.s0}: {}</Typography>
          </Box>
          <Box key={`section1`} sx={{ p: 2, borderBottom: '1px solid black' }}>
            <Typography>{local.strings.apprentissagecritique.s1}: </Typography>
          </Box>
          <Box key={`section1`} sx={{ p: 2, borderBottom: '1px solid black' }}>
            <Typography>{local.strings.apprentissagecritique.s2}: </Typography>
          </Box>
      </Box>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Box key={`section2`} sx={{ p: 2, borderBottom: '1px solid black' }}>
          <Typography>{local.strings.apprentissagecritique.s3}: </Typography>
        </Box>
        <Box key={`section2`} sx={{ p: 2, borderBottom: '1px solid black' }}>
          <Typography>{local.strings.apprentissagecritique.s4}: </Typography>
        </Box>
        <Box key={`section2`} sx={{ p: 2, borderBottom: '1px solid black' }}>
          <Typography>{local.strings.apprentissagecritique.s5}: </Typography>
        </Box>
      </Box>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Box key={`section3`} sx={{ p: 2, borderBottom: '1px solid black' }}>
          <Typography>{local.strings.apprentissagecritique.s6}: </Typography>
        </Box>
        <Box key={`section3`} sx={{ p: 2, borderBottom: '1px solid black' }}>
          <Typography>{local.strings.apprentissagecritique.s7}: </Typography>
        </Box>
        <Box key={`section3`} sx={{ p: 2, borderBottom: '1px solid black' }}>
          <Typography>{local.strings.apprentissagecritique.s8}: </Typography>
        </Box>
        <Box key={`section3`} sx={{ p: 2, borderBottom: '1px solid black' }}>
          <Typography>{local.strings.apprentissagecritique.s9}: </Typography>
        </Box>
      </Box>
    </Box>
  );
